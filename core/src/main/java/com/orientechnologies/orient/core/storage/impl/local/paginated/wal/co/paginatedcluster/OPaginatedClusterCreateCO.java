...
public class OPaginatedClusterCreateCO extends OComponentOperationRecord {
  private String clusterName;
  private int    clusterId;

  public OPaginatedClusterCreateCO() {
  }

  public OPaginatedClusterCreateCO(final String clusterName, final int clusterId) {
  ...
  @Override
  public byte getId() {
    return WALRecordTypes.CREATE_CLUSTER_CO;
  }
