...
public class ODefaultIndexFactory implements OIndexFactory {
  ...
  @Override
  public OBaseIndexEngine createIndexEngine(final int indexId, String algorithm, String name, Boolean durableInNonTxMode,
    ...
    case "plocal":
      ...
      case CELL_BTREE_ALGORITHM:
        if (multiValue) {
          ...
          indexEngine = new OCellBTreeSingleValueIndexEngine(indexId, name, (OAbstractPaginatedStorage) storage, indexId);
        }
        break;
      default:
