...
public class OLuceneIndexFactory implements OIndexFactory, ODatabaseLifecycleListener {
  ...
  @Override
  public OBaseIndexEngine createIndexEngine(final int indexId, String algorithm, String indexName, Boolean durableInNonTxMode,
      OStorage storage, int version, int apiVersion, boolean multiValue, Map<String, String> engineProperties) {

    return new OLuceneFullTextIndexEngine(indexId, storage, indexName);
